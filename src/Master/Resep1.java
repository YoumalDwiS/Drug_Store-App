...
public class Resep1 extends JFrame {
    private JPanel mResep1;
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(validasi("update")) {
                    try {
                        ...
                        String sql2 = "UPDATE mResep SET id_customer=?, nama_dokter=?, praktek=?, deskripsi=?, tgl_input=? WHERE id_resep=?";
